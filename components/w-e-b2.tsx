...
import styles from "./w-e-b2.module.css";

export type WEB2Type = {
  className?: string;
};

const WEB2: NextPage<WEB2Type> = ({ className = "" }) => {
  ...
  return (
    <div className={[styles.web, className].join(" ")}>
      ...
      />
      <img className={styles.webgel11Icon} alt="" src="/webgel-1-1@2x.png" />
      ...
      <div className={styles.webChild1} onClick={onEllipseClick2} />
      ...
      <Component2
        ...
        propOverflowX="unset"
      />
      <img className={styles.groupIcon} alt="" src="/group10@2x.png" />
      ...
      <img className={styles.webChild5} alt="" src="/group-110.svg" />
      ...
      <img className={styles.webChild44} alt="" src="/group-9.svg" />
