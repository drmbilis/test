...
import styles from "./basnda1.module.css";

const Basnda1: NextPage = () => {
  ...
  return (
    <>
      <div className={styles.basnda}>
        ...
        />
        <img className={styles.groupIcon} alt="" src="/group17@2x.png" />
        <img
